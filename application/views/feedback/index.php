        ...
        <script>
            ...
            dojo.ready(function () {
                ...
                var store = new dojo.store.JsonRest({
                    target: "/feedback/entries/"
                });
                var commentstore = new dojo.store.JsonRest({
                    target: "/feedback/comments/"
                });
                ...
                function display(entry) {
                    ...
                    if (currentList.length > 0) {
                      ...
                      if (currentIndex +1 == currentList.length) {
                        enableRight = "disabled";
                      }
                      leftButton = "<button id='prev' onClick='goPrev();'"+ enableLeft +">Previous</button>";
                      rightButton = "<button id='next' onClick='goNext();'"+ enableRight +">Next</button>";
                        countElem.innerHTML = leftButton+ cStudent + ":[id:"+
			entry.id + "] Entry " + (currentIndex + 1) + " of " + currentList.length + rightButton;
                    } else {
