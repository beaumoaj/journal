...
//require(["dojo/dom-construct"]);
  ...
  // Add a text area
  var editDiv = dojo.create("div", {id: 'editContent'}, div);
  // Add a save button
  ...
  secondDlg.attr("style", "width: 80%; text-align: left");
  var theSection;
  var theContentID;
...
// Init the rich text editor
  var myEditor = new dijit.Editor({
    height: '100px',
    value: '',
    extraPlugins: [{name: 'dijit._editor.plugins.AlwaysShowToolbar'},
      {name: 'dojox.editor.plugins.SafePaste', stripTags: [
          "html", "head", "body", "div", "table", "ol", "ul", "li", "p", "tr", "td", "script",
          "link", "meta", "a", "img", "form", "textarea", "input", "span",
          "area", "article", "aside", "audio", "b", "base", "bdi", "bdo", "big", "blockquote", "br",
          "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "datalist", "dd", "del",
          "details", "dfn", "dialog", "dir", "dl", "dt", "em", "embed", "fieldset", "figcaption", "figure",
          "font", "footer", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6",
          "header", "hr", "i", "iframe", "ins", "kbd", "keygen", "label", "legend", "main", "map",
          "menuitem", "meter", "nav", "noframes", "noscript", "object", "optgroup", "option", "output",
          "param", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "small", "source", "strike",
          "strong", "style", "sub", "summary", "sup", "tbody", "tfoot", "th", "thead", "time", "title", "track",
